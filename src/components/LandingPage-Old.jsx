            ...
            <div className="bg-white rounded-osmo-lg p-8 shadow-osmo hover:shadow-osmo-lg border border-gray-100 transition-all duration-300">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="text-sm text-gray-500 hover:text-osmo-purple transition-colors underline"
                >
                  View History
                </button>
              </div>
            ...
            <div className="bg-white rounded-osmo-lg p-8 shadow-osmo hover:shadow-osmo-lg border border-gray-100 transition-all duration-300">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="text-sm text-gray-500 hover:text-osmo-green transition-colors underline"
                >
                  View History
                </button>
              </div>
